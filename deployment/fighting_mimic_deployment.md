> Historical branch notes. For the current main-based integration, training
> contract and curriculum, use [docs/extended_obs/README.md](../docs/extended_obs/README.md).
> The commands and inherited tier relationships below describe the old branch.
