...
that body (all of the body's DOF axes share it; damping scales by the same
factor). Under BUILT_IN_PD it multiplies the nominal per-DOF gains, which are
written into the engine on reset (see ``BaseEnv._apply_body_stamina_to_gains`` ->
