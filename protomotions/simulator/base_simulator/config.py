...
class SimulatorConfig:
    ...
    projectile: Optional[ProjectileConfig] = field(
        default=None,
        metadata={
            "help": (
                "Projectile cube configuration (pool size, throw dynamics, and "
                "auto-throw curriculum). When None, defaults are used and auto-throw "
                "is disabled."
            )
        },
    )
